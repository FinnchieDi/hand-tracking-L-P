...
public class XRPlayerSnapper : MonoBehaviour
{
    ...
    public Transform xrOrigin;           // Your XR Origin GameObject (usually "XR Origin")
    public Transform targetAnchor;       // Your designated spawn point / teleport anchor
    ...
    IEnumerator SnapToAnchorDelayed()
    {
        ...
        // Optionally snap rotation (Y-axis only)
